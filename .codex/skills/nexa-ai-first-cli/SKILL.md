...
Runtime `nexa`、Python SDK/artifact、HTTP parity、governance、quality 和 deployment 在 V0.1 均为 not-selected。
不得探测缺失 binary，不得创建事实文件、占位目录或空插件，不得手改 generated artifact。
